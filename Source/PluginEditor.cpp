...
void ResponseCurveComponent::timerCallback()
{
    ...
    //if there are FFT data buffers, pull a buffer and generate a path
    ...
    /*while paths can be pulled, pull as many as possible -  only display the most recent path*/
...
peakQualitySlider(*audioProcessor.apvts.getParameter("Peak Quality"), "dB/Oct"),
